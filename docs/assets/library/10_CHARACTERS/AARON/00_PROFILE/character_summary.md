...
Aaron is a [height + build description] with [key facial features].
...
Aaron is [height description] with [body description].
...
Aaron is a [height + build] character with [distinctive facial features] and [visual style].
