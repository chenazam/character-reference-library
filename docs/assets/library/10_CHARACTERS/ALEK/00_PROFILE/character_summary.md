...
Alek is a [height + build description] with [key facial features].
...
Alek is [height description] with [body description].
...
Alek is a [height + build] character with [distinctive facial features] and [visual style].
