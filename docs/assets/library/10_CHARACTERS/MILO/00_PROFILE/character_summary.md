...
Milo is a [height + build description] with [key facial features].
...
Milo is [height description] with [body description].
...
Milo is a [height + build] character with [distinctive facial features] and [visual style].
