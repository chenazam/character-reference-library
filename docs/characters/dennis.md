...
<div class="height-lineup height-lineup--character-context">
  ...
  <div class="height-lineup__figure height-lineup__figure--a">
    <div class="height-lineup__stage">
      <img class="height-lineup__silhouette" src="/assets/library/10_CHARACTERS/DENNIS/02_BODY/structure/dennis_silhouette_front_v1_normalized.png" alt="Dennis silhouette front" style="height: 97.22%;">
    </div>
...
--8<-- "snippets/galleries/dennis/style.md"
