...
<div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(260px, 1fr)); gap:1.25rem;">
  ...
  <div style="border:1px solid #ddd; border-radius:12px; overflow:hidden; background:#fff;">
    <img src="../assets/library/10_CHARACTERS/LUCIEN/01_FACE/lucien_face_anchor_v1.png" alt="Lucien preview" style="width:100%; display:block;" />
  ...
  <div style="border:1px solid #ddd; border-radius:12px; overflow:hidden; background:#fff;">
    <img src="../assets/library/10_CHARACTERS/JONAH/11_UCS/jonah_ucs.png" alt="Jonah preview" style="width:100%; display:block;" />
    <div style="padding:1rem;">
      <h2 style="margin-top:0;">Jonah</h2>
      <p><strong>178 cm (5'10")</strong> · elongated-slender · refined, composed</p>
