...
A slender modern occultist with refined features, expressive dark eyes, and a quietly confident, slightly mischievous presence. He is characterized by a narrow angular; defined jawline; dark brown naturally curly hair with soft volume and an irregular natural hairline; dark brown, observant and expressive. His style centers on occult, with influences from scholarly and gothic. He moves with deliberate precise and projects a neutral presence.
