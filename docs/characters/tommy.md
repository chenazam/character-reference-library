...
<div class="height-lineup height-lineup--character-context">
  ...
  <div class="height-lineup__figure height-lineup__figure--a">
    <div class="height-lineup__stage">
      <img class="height-lineup__silhouette" src="/assets/library/10_CHARACTERS/TOMMY/02_BODY/structure/tommy_silhouette_front_v1_normalized.png" alt="Tommy silhouette front" style="height: 94.44%;">
    </div>
