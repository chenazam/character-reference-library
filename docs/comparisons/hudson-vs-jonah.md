...
<div class="height-lineup">
  ...
  <div class="height-lineup__figure height-lineup__figure--b">
    <div class="height-lineup__stage">
      <img class="height-lineup__silhouette" src="/assets/library/10_CHARACTERS/JONAH/02_BODY/structure/jonah_silhouette_front_v1.png" alt="Jonah silhouette front" style="height: 94.68%;">
    </div>
