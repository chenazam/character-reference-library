...
<div class="height-lineup">
  ...
  <div class="height-lineup__figure height-lineup__figure--b">
    <div class="height-lineup__stage">
      <img class="height-lineup__silhouette" src="/assets/library/10_CHARACTERS/JONAH/02_BODY/structure/jonah_silhouette_front_v1_normalized.png" alt="Jonah silhouette front" style="height: 94.68%;">
    </div>
...
Their silhouettes reinforce this contrast: **Hudson** has a **Power Athlete silhouette with **Shoulders emphasis**, characterized by tall, broad, and agile, while **Jonah** presents a **Runner Silhouette silhouette with **Legs emphasis**, characterized by long-limbed, elegant, and athletic.
