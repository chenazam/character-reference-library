...
<div class="comparison-badges">
  <div class="comparison-badge">
    ...
    <div class="comparison-badge__value">Extreme</div>
  </div>
  <div class="comparison-badge">
    <div class="comparison-badge__label">Build Contrast</div>
    <div class="comparison-badge__value">Narrow Slender vs Heavy Muscular</div>
  </div>
  <div class="comparison-badge">
    <div class="comparison-badge__label">Silhouette Contrast</div>
    <div class="comparison-badge__value">Glute Slender vs Power Frame</div>
  </div>
</div>
...
<div class="height-lineup">
  ...
  <div class="height-lineup__figure height-lineup__figure--a">
    <div class="height-lineup__stage">
      <img class="height-lineup__silhouette" src="/assets/library/10_CHARACTERS/LUCIEN/02_BODY/structure/lucien_silhouette_front_v1_normalized.png" alt="Lucien silhouette front" style="height: 81.73%;">
    </div>
...
<div class="comparison-grid comparison-grid-2">
  <div class="comparison-item">
    ...
    <img src="../../assets/library/10_CHARACTERS/LUCIEN/02_BODY/structure/lucien_body_anchor_v2.png" alt="Lucien Body Anchor Comparison">
  </div>
  <div class="comparison-item">
