...
<div class="height-chart">
  <div class="height-chart__figure">
    <div class="height-chart__bar-wrap">
      <div class="height-chart__bar" style="height: 81.73%"></div>
    </div>
    <div class="height-chart__label">Lucien</div>
  ...
  <div class="height-chart__figure">
    ...
    <div class="height-chart__label">Ragnar</div>
    <div class="height-chart__meta">208 cm / 6'10"</div>
  </div>
</div>
